"""
Scenario configuration helpers for the dynamic offloading experiments.

Defines:
- `ScenarioConfig`
- Predefined Scenario 1 / Scenario 2 variants
- Registry helpers: `ALL_SCENARIOS`, `get_scenario`, `list_scenarios`
"""
...
def list_scenarios() -> None:
    ...
    for key in ["s1_base", "s1_class1_90", "s1_class2_90", "s1_class3_90", "s1_random"]:
        ...
        print(
            f"  Task Distribution: Class1={config.task_distribution[0]:.0%}, "
